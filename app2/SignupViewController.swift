    ...
    @IBAction func RegisterBtn(_ sender: Any) {
        if EmailLabel.text?.isEmpty == true	|| PasswordLabel.text?.isEmpty == true || nickNameLabel.text?.isEmpty == true {
           ...
           //var RURecieved=RegisterUserRecieved()
            ...
            let RegisterUserData = RegisterUser(profile:Profile(email: "12@test.com", login: "12@test.com", nickName: "12", gender: "female"), credentials: Credentials(password: Password(value: "12")))
